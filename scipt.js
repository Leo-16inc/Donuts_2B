...
CartModal.addEventListener("click", function(evente){
if(evente.target === CartModal){
...
//funcão para remover o item do carrinho
...
// Verificar a hora e manipular o card do horaro
